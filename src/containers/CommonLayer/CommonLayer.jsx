...
const CommonLayer = () => {
  ...
  function LoginButton(props) {
    return (
      //  <Link to="/login">
      <>
        <p id="lgndash" onClick={props.onClick}>LOGIN / SIGNUP</p>
        </>
      //  </Link>
  ...
  function Dashboard(){
    return(
      //  <Link to="/dashboard">
      <>
       <img src={dashboard} alt="dashboard"></img> <p id="lgndash">DASHBOARD</p>
      ...
      <div className="visible-layer">
        <div className="visible-layer-top">
          ...
          <div className="visible-layer-top-dashboard">
            <div className="visible-layer-top-dashboard-main"><LogStatus/></div>
          </div>
        </div>
          <Navbar status="hover" />

...
const Layout = (props) => {
  ...
  class LogStatus extends React.Component {
    render() {
      ...
      return (
        <div
          className={props.status === "hover" ? "top-btn" : "top-btn-higher"}
        >
          {button}
        </div>
      );
  ...
  return (
    <>
      <div className="visible-layer">
        ...
        <div
          id={props.status === "hover" && props.hover ? "navhover" : ""}
          className={props.status === "hover" ? "navbarr-hover" : "navbarr"}
        ...
        <div
          className={props.status === "hover" ? "tophover" : "hud-top"}
          id="temp"
        >
          <p className={props.status === "hover" ? "tophud-text" : "notext"}>
            CEREBRO'22
          </p>
        </div>
      </div>
